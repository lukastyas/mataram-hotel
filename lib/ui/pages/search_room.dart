                            ...
                            child: Center(
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Text("* Your Children age Min 12 years old"),
                                ],
                              ),
                            ),
                          ),
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      if (state.dataSearch.selecetedDateFrom ==
                                          null) {
                                        Flushbar(
                                          duration:
                                      ...
                                      } else if (state.dataSearch.book.length ==
                                          0) {
                                        context.bloc<PageBloc>().add(
                                            GotoDetailRoom(
                                                state.dataSearch.room[index]));
                                        ...
                                        if (state.dataSearch.type == "1") {
                                          if (state.dataSearch.statusCheckin !=
                                              "2") {
                                            Flushbar(
                                              duration:
                                                  Duration(milliseconds: 1500),
